...
pub use paths::{
    ...
    agents_dir, auth_path, bin_dir, browser_profile_dir, client_path, config_path,
    global_instructions_file, log_dir, plans_dir, rate_limits_path, remote_dir, skills_dir,
