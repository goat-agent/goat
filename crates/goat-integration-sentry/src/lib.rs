...
pub const VOCABULARY: WatchVocabulary = WatchVocabulary {
    ...
    keys: &[
        KeySpec::new("project"),
        KeySpec::new("sort"),
        KeySpec::new("age").many(),
        KeySpec::new("app.in_foreground").many(),
        KeySpec::new("assigned").many().selfref(),
        KeySpec::new("assigned_or_suggested").many().selfref(),
        KeySpec::new("bookmarks").many().selfref(),
        KeySpec::new("device.arch").many(),
        KeySpec::new("device.brand").many(),
        KeySpec::new("device.family").many(),
        KeySpec::new("device.locale").many(),
        KeySpec::new("device.model_id").many(),
        KeySpec::new("device.orientation").many(),
        KeySpec::new("device.screen_density").many(),
        KeySpec::new("device.screen_dpi").many(),
        KeySpec::new("device.screen_height_pixels").many(),
        KeySpec::new("device.screen_width_pixels").many(),
        KeySpec::new("device.uuid").many(),
        KeySpec::new("dist").many(),
        KeySpec::new("error.handled").many(),
        KeySpec::new("error.main_thread").many(),
        KeySpec::new("error.mechanism").many(),
        KeySpec::new("error.type").many(),
        KeySpec::new("error.unhandled").many(),
        KeySpec::new("error.value").many(),
        KeySpec::new("event.timestamp").many(),
        KeySpec::new("event.type").many(),
        KeySpec::new("firstrelease").many(),
        KeySpec::new("firstseen").many(),
        KeySpec::new("geo.city").many(),
        KeySpec::new("geo.country_code").many(),
        KeySpec::new("geo.region").many(),
        KeySpec::new("has").many(),
        KeySpec::new("http.method").many(),
        KeySpec::new("http.referer").many(),
        KeySpec::new("http.status_code").many(),
        KeySpec::new("http.url").many(),
        KeySpec::new("id").many(),
        KeySpec::new("is").many(),
        KeySpec::new("issue").many(),
        KeySpec::new("issue.category").many(),
        KeySpec::new("issue.type").many(),
        KeySpec::new("lastseen").many(),
        KeySpec::new("level").many(),
        KeySpec::new("location").many(),
        KeySpec::new("message").many(),
        KeySpec::new("os.build").many(),
        KeySpec::new("os.distribution_name").many(),
        KeySpec::new("os.distribution_version").many(),
        KeySpec::new("os.kernel_version").many(),
        KeySpec::new("platform.name").many(),
        KeySpec::new("project.id").many(),
        KeySpec::new("release").many(),
        KeySpec::new("release.build").many(),
        KeySpec::new("release.package").many(),
        KeySpec::new("release.stage").many(),
        KeySpec::new("release.version").many(),
        KeySpec::new("sdk.name").many(),
        KeySpec::new("sdk.version").many(),
        KeySpec::new("stack.abs_path").many(),
        KeySpec::new("stack.filename").many(),
        KeySpec::new("stack.function").many(),
        KeySpec::new("stack.module").many(),
        KeySpec::new("stack.package").many(),
        KeySpec::new("timesseen").many(),
        KeySpec::new("timestamp").many(),
        KeySpec::new("title").many(),
        KeySpec::new("trace").many(),
        KeySpec::new("transaction").many(),
        KeySpec::new("unreal.crash_type").many(),
        KeySpec::new("user.email").many(),
        KeySpec::new("user.id").many(),
        KeySpec::new("user.ip").many(),
        KeySpec::new("user.username").many(),
    ],
};
